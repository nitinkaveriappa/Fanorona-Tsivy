...
<div class="contents" align="center">
	...
	<form action="createPlayer.php" method="post" onsubmit="return validate();" >
   		<input class="formDetail" type="text" name = "rMemName"  placeholder="Member Name" size="30px" required><br/><br/>
    	<input class="formDetail" type="text" name = "rMemEmail"  placeholder="Email" size="30px" onchange="EmailChecking(this.value);" pattern="^[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\.[a-zA-Z]{1,4}"><br/>
        <span id="EmailExist" style="color:#F00;"></span><br/>
		<input class="formDetail" type="password" name = "rMemPassword" placeholder="Password" size="30px" required><br/><br/>
